        ...
        <div className="bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg bg-white border border-slate-200 text-xs text-slate-600 focus:outline-none focus:ring-1 focus:ring-orange-500/30 focus:border-orange-500 transition-all"
            >
